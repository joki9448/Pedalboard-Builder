...
c1 = Config.create(user_id: u1.id, signal_chain: "this > that")
...
Pedal.create(brand: "TC Electronic", model: "Honey Pot Fuzz", effect: "Distortion / Gain", config_id: c1.id)
...
Pedal.create(brand: "Dunlop", model: "Tom Morello Wah", effect: "Expression", config_id: c1.id)
...
Pedal.create(brand: "MXR", model: "Dyna Comp Mini", effect: "Compression / EQ", config_id: c1.id)
...
Pedal.create(brand: "MXR", model: "Six Band EQ", effect: "Compression / EQ", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Ten Band EQ", effect: "Compression / EQ", config_id: c1.id)

Pedal.create(brand: "MXR", model: "Carbon Copy", effect: "Reverb / Delay", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Carbon Copy Deluxe", effect: "Reverb / Delay", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Carbon Copy Mini", effect: "Reverb / Delay", config_id: c1.id)
Pedal.create(brand: "MXR", model: "M300 Digital Reverb", effect: "Reverb / Delay", config_id: c1.id)
...
Pedal.create(brand: "MXR", model: "EVH 5150 Chorus", effect: "Modulation", config_id: c1.id)
Pedal.create(brand: "MXR", model: "EVH Phase 90", effect: "Modulation", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Micro Chorus", effect: "Modulation", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Micro Flanger", effect: "Modulation", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Mini Phase 95", effect: "Modulation", config_id: c1.id)
...
Pedal.create(brand: "MXR", model: "Classic 108 Fuzz", effect: "Distortion / Gain", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Custom Badass '78", effect: "Distortion / Gain", config_id: c1.id)
...
Pedal.create(brand: "MXR", model: "EVH 5150 Overdrive", effect: "Distortion / Gain", config_id: c1.id)
...
Pedal.create(brand: "MXR", model: "Micro Amp +", effect: "Distortion / Gain", config_id: c1.id)
Pedal.create(brand: "MXR", model: "Custom Badass Modified OD", effect: "Distortion / Gain", config_id: c1.id)
